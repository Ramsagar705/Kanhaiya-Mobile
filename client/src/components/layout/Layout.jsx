...
const Layout = () => (
  <div className="min-h-screen bg-[#f7f8fb] text-slate-900">
    <Navbar />
    <main className="page-enter mx-auto max-w-7xl px-4 py-7 sm:px-6 lg:px-10 lg:py-10">
      <Outlet />
    </main>
